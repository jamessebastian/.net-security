...
namespace Security.Controllers
{
    public class AnswersController : Controller
    {
        ...
        {
            var stackOverflowContext = _context.Answers.Include(a => a.Question);
        ...
        public async Task<IActionResult> Create([Bind("AnswerID,QuestionID,AnswerText,DatePosted")] Answer answer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AnswerID,QuestionID,AnswerText,DatePosted")] Answer answer)
        {
